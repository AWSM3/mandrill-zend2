...
/**
 * Ips.php
 * Freax, started: Oct 26, 2015 4:47:56 PM.
 *
...
class Ips extends AbstractApi
{
    ...
    {
        return $this->request('start-warmup', [
            'ip' => $ip,
        ]);
    }
    ...
    {
        return $this->request('delete-pool', [
            'pool' => $pool,
        ]);
    }
    ...
    {
        return $this->request('check-custom-dns', [
            'ip' => $ip,
            'domain' => $domain,
        ]);
    }
    ...
    {
        return $this->request('set-custom-dns', [
            'ip' => $ip,
            'domain' => $domain,
        ]);
    }
